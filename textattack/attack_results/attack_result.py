...
class AttackResult(ABC):
    ...
    def original_text(self, color_method=None):
        ...
        Helper method.
        """
        # print("self.original_result.attacked_text: ", self.original_result.attacked_text)
    ...
    def perturbed_text(self, color_method=None):
        ...
        Helper method.
        """
        # print("self.perturbed_result.attacked_text: ", self.perturbed_result.attacked_text)
    ...
    def diff_color(self, color_method=None):
        ...
        # print("diff_color t1: ", t1)
        # print("diff_color t2: ", t2)
